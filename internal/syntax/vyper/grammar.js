...
module.exports = grammar({
  ...
  rules: {
    ...
    for_statement: $ => seq(
      ...
      optional(seq(':', field('type', alias($._loop_type, $.type)))),
      'in',
    ...
    _loop_type: $ => choice($.identifier, $.subscript, $.attribute),
    ...
    named_expression: $ => prec.right(seq(
      field('name', $.identifier),
      ':=',
      field('value', $.expression),
    )),
    ...
    extcall: $ => prec(PREC.call - 1, seq(
      'extcall',
      $.call,
    )),

    staticcall: $ => prec(PREC.call - 1, seq(
      'staticcall',
      $.call,
    )),
